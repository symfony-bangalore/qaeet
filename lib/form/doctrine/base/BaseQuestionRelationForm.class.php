...
/**
 * QuestionRelation form base class.
 *
 * @method QuestionRelation getObject() Returns the current form's model object
 *
 * @package    qa
 * @subpackage form
 ...
 */
abstract class BaseQuestionRelationForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('question_relation[%s]');
